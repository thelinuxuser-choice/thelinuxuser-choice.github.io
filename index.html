...
content="ie=edge" />
        <title>thelinuxuser-choice</title>
		<link rel="stylesheet" 
...
<div>
		 <a href="https://www.youtube.com/channel/UCv7civaWFtTlXmzxv5o1IMw" 
style="color: #9ffc08; font-size: 30px; float: left; padding-top: 10px ; margin-left: 10px;">YouTube</a>
<div>
		 <a href="https://github.com/thelinuxuser-choice" 
style="color: #9ffc08; font-size: 30px; float: center; padding-top: 10px ; margin-left: 1000px;">Github</a>
		</div>
		</div>
<div class="pad" style="text-align: center; 
position: absolute; width:100%;">
			<h1 style="color: #9ffc08; font-size: 
4.5rem; font-weight: 400; margin-bottom: 5px;"> thelinuxuser-choice</h1>
			<div style="color: #1aff00; font-weight: 
300;"><span style="font-size: 2rem;" id="typer"></span><span 
style="font-size: 3rem; animation: blink 1s infinite;" 
>|</span></div>

	<div style="color: #9ffc08; font-weight: 
300;"><span style="font-size: 2rem;" id="typer"></span><span 
style="font-size: 3rem; animation: blink 1s infinite;" 
>|</span></div>
		</div>
